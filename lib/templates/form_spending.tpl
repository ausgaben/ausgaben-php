...
{/if}
        <tr {if isset($class)}class="{$class}"{/if}>
                <td colspan="4">
                        ...
                        <input type="text" name="spendingtype_name" class="medium" tabindex="2" {if isset($spending)}value="{$spendingtypes[$spending.spendingtype_id].name}"{/if} />
        ...
        <tr {if isset($class)}class="{$class}"{/if}>
                <td><input type="text" name="day" class="tiny" tabindex="1" value="{if isset($spending)}{$spending.day}{else}{$smarty.now|date_format:'%d'}{/if}" />.<input type="text" name="month" class="tiny" tabindex="2" value="{if isset($spending)}{$spending.month}{else}{$smarty.now|date_format:'%m'}{/if}" />.<input type="text" name="year" class="small" tabindex="3" value="{if isset($spending)}{$spending.year}{else}{$smarty.now|date_format:'%Y'}{/if}" /></td>
                <td><input type="text" name="description" class="large" tabindex="4" {if isset($spending)}value="{$spending.description}"{/if} /></td>
